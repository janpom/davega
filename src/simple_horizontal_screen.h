...
#ifndef SIMPLE_HORIZONTAL_SCREEN_H
#define SIMPLE_HORIZONTAL_SCREEN_H

#include <TFT_22_ILI9225.h>
#include "ili9225_screen.h"
#include "simple_screen.h"

class SimpleHorizontalScreen: public ILI9225Screen {
public:
    SimpleHorizontalScreen(t_screen_item primary_item) { _primary_item = primary_item; }
    void reset();
...
#endif //SIMPLE_HORIZONTAL_SCREEN_H
